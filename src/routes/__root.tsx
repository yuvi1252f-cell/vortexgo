...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "BARMUDA CLASH" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "BARMUDA CLASH — Daily Skill-Based Gaming Tournaments & Rewards" },
      { name: "twitter:title", content: "BARMUDA CLASH — Daily Skill-Based Gaming Tournaments & Rewards" },
      { property: "og:description", content: "Join BARMUDA CLASH: daily free-entry esports tournaments, instant UPI withdrawals, fair-play matches and 24/7 support. Download the app and start winning." },
      { name: "twitter:description", content: "Join BARMUDA CLASH: daily free-entry esports tournaments, instant UPI withdrawals, fair-play matches and 24/7 support. Download the app and start winning." },
